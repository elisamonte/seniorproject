...
Partial Class ApiClient
    ...
    Private Async Sub btnAllProducts_ClickAsync(sender As Object, e As EventArgs) Handles btnAllProducts.Click
        ...
        Dim uri As String = "https://localhost:44339/api/product"
    ...
    Protected Async Sub btnAddToWishlist_Click(sender As Object, e As EventArgs) Handles btnAddToWishlist.Click

        Dim uri As String = "https://localhost:44339/api/product"
        Dim task = Await httpClient.GetAsync(uri)

        Dim atLeastOneRowSelected As Boolean = False
        For Each row As GridViewRow In gvAllProducts.Rows
            Dim cb As CheckBox = row.FindControl("ProductSelector")
            If cb IsNot Nothing AndAlso cb.Checked Then
                atLeastOneRowSelected = True
                Dim productID As Integer = Convert.ToInt32(gvAllProducts.DataKeys(row.RowIndex).Value)
                AddedToWishlist.Text &= String.Format("You have added product {0} to your wishlist.<br />", productID)
            End If
        Next
        AddedToWishlist.Visible = atLeastOneRowSelected

    End Sub

    Private Async Sub ToggleCheckState(ByVal checkState As Boolean)
    ...
    Protected Async Sub CheckAll_Click(sender As Object, e As EventArgs) Handles CheckAll.Click
    ...
    Protected Async Sub UncheckAll_Click(sender As Object, e As EventArgs) Handles UncheckAll.Click
    ...
    Public Async Sub btnProductID_ClickAsync(sender As Object, e As EventArgs) Handles btnProductID.Click
        ...
        Dim uri As String = "https://localhost:44339/api/product/" & tbProductID.Value
        Dim task = Await httpClient.GetAsync(uri)
    ...
    Private Async Sub btnUpdateProduct_ClickAsync(sender As Object, e As EventArgs) Handles btnUpdateProduct.Click
        ...
        httpClient.DefaultRequestHeaders.Authorization = New AuthenticationHeaderValue("Bearer", getToken())
        Dim uri As String = "https://localhost:44339/api/product/" & tbUpdateProductID.Value
    ...
    Private Async Sub btnDeleteProductID_ClickAsync(sender As Object, e As EventArgs) Handles btnDeleteProductID.Click
        ...
        httpClient.DefaultRequestHeaders.Authorization = New AuthenticationHeaderValue("Bearer", getToken())
        Dim uri As String = "https://localhost:44339/api/product/" & tbDeleteProductID.Value
    ...
    Private Async Sub btnAllCarts_ClickAsync(sender As Object, e As EventArgs) Handles btnAllCarts.Click
        ...
        Dim uri As String = "https://localhost:44339/api/cart"
        Dim task = Await httpClient.GetAsync(uri)
        Dim jsonString = Await task.Content.ReadAsStringAsync()
        If task.IsSuccessStatusCode Then
            Dim table As DataTable = JsonConvert.DeserializeObject(Of DataTable)(jsonString)
    ...
    Private Async Sub btnDeleteCartLineID_ClickAsync(sender As Object, e As EventArgs) Handles btnDeleteCartLineID.Click
        ...
        httpClient.DefaultRequestHeaders.Authorization = New AuthenticationHeaderValue("Bearer", getToken())
        Dim uri As String = "https://localhost:44339/api/cart/" & tbDeleteCartLineID.Value
        Await httpClient.DeleteAsync(uri)
    ...
    Private Async Sub btnCartByID_ClickAsync(sender As Object, e As EventArgs) Handles btnCartByID.Click
        ...
        Dim uri As String = "https://localhost:44339/api/cart/" & tbGetCartID.Value
        Dim task = Await httpClient.GetAsync(uri)
        Dim jsonString = Await task.Content.ReadAsStringAsync()
        If task.IsSuccessStatusCode Then
            Dim table As DataTable = JsonConvert.DeserializeObject(Of DataTable)(jsonString)
    ...
    Private Async Sub btnCurrentCart_ClickAsync(sender As Object, e As EventArgs) Handles btnCurrentCart.Click
        If strCartID IsNot Nothing Then
            ...
            Dim uri As String = "http://localhost:44339/api/cart/" & strCartID
            Dim task = Await httpClient.GetAsync(uri)
            Dim jsonString As String = Await task.Content.ReadAsStringAsync()
            If task.IsSuccessStatusCode Then
                Dim table As DataTable = JsonConvert.DeserializeObject(Of DataTable)(jsonString)
    ...
    Private Async Sub btnUpdateCartQty_ClickAsync(sender As Object, e As EventArgs) Handles btnUpdateCartQty.Click
        ...
        Dim uri As String = "https://localhost:44339/api/cart/" & tbUpdateQtyCartLineID.Value
    ...
    Private Async Sub btnImportProductID_ClickAsynce(sender As Object, e As EventArgs) Handles btnImportProductID.Click
        Dim uri As String = "https://localhost:44339/api/product/" & tbImportProductID.Value
        Dim task = Await httpClient.GetAsync(uri)
        Dim jsonString = Await task.Content.ReadAsStringAsync()
    ...
    Private Async Sub btnApiLogin_ClickAsync(sender As Object, e As EventArgs) Handles btnApiLogin.Click
        ...
        Dim uri As String = "https://localhost:44339/account/login"
        ...
        If task.IsSuccessStatusCode Then
            ...
            'tokenCookie.Secure = True //use if HTTPS for added security. Current ApiClient page is HTTP
